...
> **状态**：~~蓝图初稿~~ → **已被取代**
>
> 本文档的内容已由以下两份文档完整覆盖并演进：
> - `docs/Ai-Design/KRIG-Atom体系设计文档.md`（统一 Atom 层 + Converter 规范）
> - `docs/Ai-Design/KRIG-SurrealDB-Schema设计文档.md`（统一 Schema + 知识图谱表结构）
>
> 本文档保留为历史参考，不再更新。新的设计讨论请在上述两份文档中进行。
